...
% Version 2.0 (5/6/22)
%
% This class modified originates from:
...
\documentclass[9pt]{stackoverflow-upgraded-version} % Default font size, values from 8-12pt are recommended
...
\begin{minipage}[t]{0.31\textwidth} % 27.5% of the page width for the first row of icons
	...
	\icon{MapMarker}{12}{Venice, Italy}\\
	\icon{Phone}{12}{+1 123 456 789}\\
	\icon{At}{12}{\href{mailto:alessandra.bilardi@gmail.com}{alessandra.bilardi@gmail.com}}\\	
\end{minipage}
\begin{minipage}[t]{0.24\textwidth} % 27.5% of the page width for the second row of icons
	...
	% The first parameter is the FontAwesome icon name, the second is the box size and the third is the text
	% Other icons can be found by referring to fontawesome.pdf (supplied with the template) and using the word after \fa in the command for the icon you want
	\icon{Globe}{12}{\href{https://alessandra.bilardi.net}{alessandra.bilardi.net}}\\
	\icon{Github}{12}{\href{https://github.com/bilardi}{github.com/bilardi}}\\
	\icon{Twitter}{12}{\href{https://twitter.com/@abilardi}{@abilardi}}\\
\end{minipage}
...
\begin{entrylist}
	...
	\entry
		...
		\sci{My job detail}. Technical consultant and promoter of new services or systems: principally versioning and storing. \iu{Programmer}:
